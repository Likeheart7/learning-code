...
public class HTMLColor {
    ...
    public static final Map<Integer, String> MAP = Arrays.stream(ARRAY).collect(Collectors.toMap(
            // 键映射和值映射
     ...
     * 给定颜色名，查找RGB值
     */
    public static Integer rgb(String color) {
        return INVMAP.get(color);
    }
    ...
    public static void show(Map<Integer, String> m, int count) {
        m.entrySet().stream()
                .limit(count).forEach(HTMLColor::show);
    }
